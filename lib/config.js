module.exports = {
    uri: {
        ...
        GET_FARMERS_AIS : '/ai/get-farmers-ais/{string:token}',
        ...
        TEST_AI : '/ai/test/{int:id}/{int:leekId}/{array:bots}/{string:type}/{string:token}',
        //CHANGELOG
        ...
        REGISTER_FARMER : '/farmer/register/{string:login}/{string:password}/{string:email}/{string:leek_name}/{string:godfather}',
