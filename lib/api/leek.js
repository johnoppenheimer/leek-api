module.exports = (function(){
    ...
    return {
        ...
        getImage: function(leek, scale, callback){
            var options = {};
            options.leek = leek;
            options.scale = scale;
        ...
        spendCapital: function(leek, characteristics, callback){
            var options = {};
            options.leek = leek;
